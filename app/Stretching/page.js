...
import stretchingExercises from "./Stretching.json";
import Link from "next/link";

export default function StretchingPage() { 
    const [exercises, setExercises] = useState(stretchingExercises);
    ...
    return (
        ...
        <div className="bg-gray-600">
            <h1 className="text-2xl font-bold mb-4">Stretching Exercises</h1>
